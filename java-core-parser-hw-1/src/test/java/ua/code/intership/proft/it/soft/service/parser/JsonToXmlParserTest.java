...
class JsonToXmlParserTest {
    ...
    void testParseShouldWithoutThrow() {
        assertDoesNotThrow(() ->
                fileParser.parse(PATH_TO_TEST_JSON_FILE_LIST, PATH_TO_TEST_XML_FILE_LIST, PlanetAttribute.ATMOSPHERIC_COMPOSITION));
    }

    @Test
    void testParseShouldThrowWithoutPathToJsonFileList() {
        Throwable exception = assertThrows(IllegalArgumentException.class, () ->
                fileParser.parse(null, PATH_TO_TEST_XML_FILE_LIST, PlanetAttribute.ATMOSPHERIC_COMPOSITION));
    ...
    void testParseShouldThrowWithoutValidAttribute() {
        ...
        Throwable exception = assertThrows(IllegalArgumentException.class, () ->
                fileParser.parse(PATH_TO_TEST_JSON_FILE_LIST, PATH_TO_TEST_XML_FILE_LIST, attribute));
    ...
    void testParseShouldThrowWithoutPathToDirectory() {
        ...
        Throwable exception = assertThrows(IllegalArgumentException.class, () ->
                fileParser.parse(path, PATH_TO_TEST_XML_FILE_LIST, PlanetAttribute.ATMOSPHERIC_COMPOSITION));
