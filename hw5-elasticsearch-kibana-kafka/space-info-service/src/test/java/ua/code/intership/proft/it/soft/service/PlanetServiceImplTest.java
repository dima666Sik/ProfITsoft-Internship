...
class PlanetServiceImplTest {
    ...
    @Mock
    private KafkaOperations<String, PlanetReceivedMessage> kafkaOperations;
    ...
    void createPlanet() {
        ...
        when(kafkaOperations.send(anyString(), anyString(), any(PlanetReceivedMessage.class))).thenAnswer(invocation -> future);
