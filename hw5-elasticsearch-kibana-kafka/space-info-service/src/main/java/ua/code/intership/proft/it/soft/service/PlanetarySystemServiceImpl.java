...
import ua.code.intership.proft.it.soft.domain.mapper.PlanetarySystemMapper;
import ua.code.intership.proft.it.soft.repository.PlanetarySystemRepository;

import java.util.List;

import static ua.code.intership.proft.it.soft.domain.mapper.PlanetarySystemMapper.planetarySystemRequestDtoIntoPlanetarySystem;
